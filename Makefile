...
reader_daemon: $(READER_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC)
	$(CXX) $(CXXFLAGS) -I$(INCLUDE_DIR) \
		$(READER_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC) \
		-o $(BUILD_DIR)/reader_daemon $(LDFLAGS)

writer1_daemon: $(WRITER1_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC)
	$(CXX) $(CXXFLAGS) -I$(INCLUDE_DIR) \
		$(WRITER1_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC) \
		-o $(BUILD_DIR)/writer1_daemon $(LDFLAGS)

writer2_daemon: $(WRITER2_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC)
	$(CXX) $(CXXFLAGS) -I$(INCLUDE_DIR) \
		$(WRITER2_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC) \
		-o $(BUILD_DIR)/writer2_daemon $(LDFLAGS)

logger_daemon: $(LOGGER_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC)
	$(CXX) $(CXXFLAGS) -I$(INCLUDE_DIR) \
		$(LOGGER_DAEMON_SRC) $(SHAREDMEM_SRC) $(DAEMONIZER_SRC) \
