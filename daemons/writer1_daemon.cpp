...
int main(int argc, char* argv[]) {
    ...
    Logger logger(500, LogLevel::DEBUG, "/tmp/writer1.log");
    ...
    if (!res.result) {
        logger.log(LogLevel::ERROR, "Writer1", "Failed to create writer1 queue: " + res.message);
    ...
    while (writer1_running) {
        ...
        if (!res.result && foreground_mode) {
            ...
            logger.log(LogLevel::ERROR, "Writer1", "Failed to publish: " + res.message);
    ...
    logger.log(LogLevel::INFO, "Writer1", "Writer1 shutting down");
